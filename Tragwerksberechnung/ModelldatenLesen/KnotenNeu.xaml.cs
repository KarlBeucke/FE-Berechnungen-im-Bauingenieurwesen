    ...
    public partial class KnotenNeu
    {
        ...
        public KnotenNeu(FeModell feModell)
        {
            ...
            if (_modell.Raumdimension < 3)
                StartFenster.TragwerkVisual.VisualElastizitätModel.Background = Brushes.Transparent;
            ShowDialog();
        ...
        private void BtnDialogCancel_Click(object sender, RoutedEventArgs e)
        {
            ...
            StartFenster.TragwerkVisual.VisualElastizitätModel.Children.Remove(StartFenster.TragwerkVisual.Pilot);
            StartFenster.TragwerkVisual.VisualElastizitätModel.Background = null;
            _knotenKeys?.Close();
            Close();
