...
public partial class KnotenNeu
{
    ...
    public KnotenNeu(FeModell feModell)
    {
        ...
        StartFenster.StabwerkVisual.VisualStabwerkModel.Background = Brushes.Transparent;
        Show();
    ...
    private void BtnDialogCancel_Click(object sender, RoutedEventArgs e)
    {
        ...
        StartFenster.StabwerkVisual.VisualStabwerkModel.Children.Remove(StartFenster.StabwerkVisual.Pilot);
        StartFenster.StabwerkVisual.VisualStabwerkModel.Background = null;
        _knotenKeys?.Close();
        Close();
        StartFenster.StabwerkVisual.IsKnoten = false;
    ...
    private void BtnTabelleneintrag(object sender, RoutedEventArgs e)
    {
        ...
        KnotenGrid?.ItemsSource = _knotenListe;
